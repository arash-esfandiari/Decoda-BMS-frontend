        ...
        <div className="container mx-auto max-w-6xl py-8">
            <div className="flex justify-between items-end mb-8">
                <div>
                    ...
                    <p className="text-slate-500 mt-1">View available services and treatments: {totalServices} Total</p>
                </div>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-white/30 hover:bg-white/30">
                                <HeaderCell field="name" className="pl-6">Service Name</HeaderCell>
                                <HeaderCell field="description">Description</HeaderCell>
                                <HeaderCell field="price">Price</HeaderCell>
                                <HeaderCell field="duration" className="pr-6">Duration</HeaderCell>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
